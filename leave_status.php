...
//echo $uname;
$query=mysql_query("select * from student_reg where uname='$uname'");
$row=mysql_fetch_array($query);
$username=$row['name'];
$qry=mysql_query("select * from  leave_request where name='$username'");
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-3" id="link-effect-3">
						<ul class="nav navbar-nav">
							<li ><a href="student_home.php" data-hover="Home">HOME</a></li>
							<li ><a href="leave_request.php">LEAVE REQUEST</a></li>
							<li class="active"><a href="leave_status.php">LEAVE STATUS</a></li>
...
<div class="about-top-w3layouts">
  <form name="form1" method="post" action="">
    <h2 align="center">LEAVE REQUEST STATUS </h2>
    <p align="center">&nbsp;</p>
