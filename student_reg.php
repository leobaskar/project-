...
{
 $rdate =date("d-m-y");
$max_qry = mysql_query("select max(id) from student_reg");
	$max_row = mysql_fetch_array($max_qry); 
	$id=$max_row['max(id)']+1;
  $qry=mysql_query("insert into student_reg values('$id','$name','$fname','$rollno','$class','$department','$dob','$age','$gender','$contact1','$contact2','$email','$address','$uname','$pass','$rdate')");
if($qry)
{
?>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-3" id="link-effect-3">
						<ul class="nav navbar-nav">
							...
							<li ><a href="login.php" data-hover="About Us">WARDEN</a></li>
							<li class="active"><a href="stu_login.php" data-hover="Gallery">STUDENT</a></li>
						</ul>
					</nav>
				</div>
			</nav>	
				<h2 class="inner-tittle-w3layouts">STUDENT</h2>
		</div>
	</div>
</div>
<!-- //banner -->
...
<div class="about-top-w3layouts">
  <form name="form1" method="post" action="">
    ...
    <p align="center">&nbsp;</p>
    <p align="center">&nbsp;</p>
    <table width="637" height="565" border="0" align="center">
      <tr>
        <th width="180" scope="row">Name</th>
        <td width="303"><label>
      ...
      <tr>
        ...
        <td><label>
          <input name="rollno" type="text" id="rollno" required>
        </label></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><label>
          <input name="department" type="text" id="department" required>
        </label></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><label>
          <input name="contact1" type="text" id="contact1" required placeholder="Your Contact">
        </label>
          ,
          <label>
          <input name="contact2" type="text" id="contact2" required placeholder="Father Contact">
          </label></td>
      </tr>
      <tr>
