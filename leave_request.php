...
{
 $rdate =date("d-m-y");
$max_qry = mysql_query("select max(id) from leave_request");
	$max_row = mysql_fetch_array($max_qry); 
	$id=$max_row['max(id)']+1;
  $qry=mysql_query("insert into leave_request values('$id','$name','$rollno','$leave_days','$purpose','$up_date','$end_date','0','0','$rdate')");
if($qry)
{
?>
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-3" id="link-effect-3">
						<ul class="nav navbar-nav">
							...
							<li class="active"><a href="leave_request.php">LEAVE REQUEST</a></li>
...
<div class="about-top-w3layouts">
  <form name="form1" method="post" action="">
    ...
    <p>&nbsp;</p>
    <table width="605" height="271" border="0" align="center">
      <tr>
      ...
      <tr>
        ...
        <td><label>
          <input type="text" name="leave_days" required>
        </label></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><label>
          <input type="date" name="up_date" required>
        To 
