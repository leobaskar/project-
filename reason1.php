...
$bid=$_REQUEST['rid'];
$query=mysql_query("select * from leave_request where id=$bid");
$row=mysql_fetch_array($query);
$name=$row['name'];
if(isset($btn))
{
$update=mysql_query("update leave_request set status=1,report='$reason' where id=$bid");
if($update)
{
?>
<script language="javascript">
alert("Permission Rejected...");
window.location.href="leave_request_view.php"
 </script>
<?php
}
else
				...
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="link-effect-3" id="link-effect-3">
						<ul class="nav navbar-nav">
							...
							<li class="active" ><a href="leave_request_view.php" >STUDENT LEAVE RQUEST</a></li>
...
<div class="about-top-w3layouts">
  <form name="form1" method="post" action="">
    <h2 align="center">REPLY TO STUDENT </h2>
    <table width="323" height="197" border="0" align="center">
      <tr>
      ...
      <tr>
        <th scope="row">&nbsp;</th>
        <td><label>
          <input type="submit" name="btn" value=" Reject Reply">
        </label></td>
      </tr>
    </table>
    <p align="center">&nbsp; </p>
